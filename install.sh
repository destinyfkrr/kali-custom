...
mkdir -p ~/vpn /opt/tools/netcat /opt/tools/chisel

# Download files
wget -O /opt/tools/linpeas.sh https://github.com/peass-ng/PEASS-ng/releases/download/20240623-7d729c04/linpeas.sh
wget -O /opt/tools/Winpeas.exe https://github.com/peass-ng/PEASS-ng/releases/download/20240623-7d729c04/winPEASany.exe
